...
export const translations = {
  id: {
    ...
    // Filters
    filterPunctuation: "Hapus Tanda Baca",
    filterSymbols: "Hapus Simbol",
    filterNumbers: "Hapus Angka",
    filterLetters: "Format Huruf",
    filterLettersNone: "Tidak ada",
    filterLettersRemove: "Hapus semua huruf",
    filterLettersLower: "Kecil semua",
    filterLettersUpper: "Besar semua",
    batchEditLabel: "Batch Edit (klik kata untuk ganti semua)",
  ...
  en: {
    ...
    // Filters
    filterPunctuation: "Remove Punctuation",
    filterSymbols: "Remove Symbols",
    filterNumbers: "Remove Numbers",
    filterLetters: "Letter Format",
    filterLettersNone: "None",
    filterLettersRemove: "Remove all letters",
    filterLettersLower: "All lowercase",
    filterLettersUpper: "All uppercase",
    batchEditLabel: "Batch Edit (click word to replace all)",
  ...
  zh: {
    ...
    // Filters
    filterPunctuation: "删除标点符号",
    filterSymbols: "删除符号",
    filterNumbers: "删除数字",
    filterLetters: "字母格式",
    filterLettersNone: "无",
    filterLettersRemove: "删除所有字母",
    filterLettersLower: "全部小写",
    filterLettersUpper: "全部大写",
    batchEditLabel: "批量编辑（点击单词以替换所有）",
