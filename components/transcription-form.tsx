...
- Jangan ubah, hapus, atau terjemahkan token berbentuk zzentityzNzz (huruf kecil + angka) — biarkan persis apa adanya, itu placeholder yang akan direstore otomatis.
...
export function TranscriptionForm() {
  ...
  return (
    <div className="w-full max-w-3xl lg:max-w-4xl xl:max-w-5xl flex flex-col gap-4">
      ...
      {/* Shared Known Entities Dictionary Modal */}
